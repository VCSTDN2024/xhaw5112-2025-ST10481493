...
class MainActivity2 : AppCompatActivity() {
    ...
    private lateinit var btn_toclacfees: Button
    private lateinit var btn_tocourse: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_tocourse = findViewById(R.id.btn_tocourse)
        btn_toclacfees = findViewById(R.id.btn_toclacfees)
        ...
        btn_toclacfees.setOnClickListener {
            startActivity(Intent(this, MainActivity4::class.java))
            finish()
        }

        btn_tocourse.setOnClickListener {
